...
(define-yason-encoder #. (find-class 'queue))
(define-yason-encoder #. (find-class 'running))
(define-yason-encoder #. (find-class 'build-log))
(define-yason-encoder #. (find-class 'build-queue))
(define-yason-encoder #. (find-class 'archive))
